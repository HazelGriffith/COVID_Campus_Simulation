...
int main(){
    ...
    filterProbGetSick = dynamic::translate::make_dynamic_atomic_model<Filter_ProbGetSick, TIME>("filterProbGetSick", move(i_personID));
    ...
    submodels_TOP = {input_reader, filterProbGetSick};
    ...
    eocs_TOP = {
        dynamic::translate::make_EOC<Filter_ProbGetSick_ports::outFromFilter,top_out>("filterProbGetSick")
    };

    dynamic::modeling::ICs ics_TOP;
    ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<ProbGetSick>::out,Filter_ProbGetSick_ports::inToFilter>(
                                           "input_reader","filterProbGetSick")
    };
	...
	/***** (6) *****/
    /*************** Loggers *******************/
    static ofstream out_ProbGetSick("../simulation_results/filter_ProbGetSick_test_output_ProbGetSick.txt");
    ...
    static ofstream out_state("../simulation_results/filter_ProbGetSick_test_output_state.txt");
