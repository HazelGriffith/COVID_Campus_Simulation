...
int main(){
    ...
    const char * i_input_data = "../input_data/filter_People_In_input_test.txt";
	...
	/***** (4) *****/
    /****** filter_People_In atomic model instantiation *******************/
    ...
    submodels_TOP = {input_reader, filterIn};
    ...
    eocs_TOP = {
        dynamic::translate::make_EOC<Filter_People_In_ports::outFromFilter,top_out>("filterIn")
    };

    dynamic::modeling::ICs ics_TOP;
    ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<PersonInfo>::out,Filter_People_In_ports::inToFilter>(
                                           "input_reader","filterIn")
    };
	...
	/***** (6) *****/
    /*************** Loggers *******************/
    static ofstream out_PersonInfo("../simulation_results/filter_People_In_test_output_PersonInfo.txt");
    ...
    static ofstream out_state("../simulation_results/filter_People_In_test_output_state.txt");
