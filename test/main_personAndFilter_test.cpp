...
int main(){
    ...
    submodels_TOP = {input_reader, person, probGetSickFilter};
    ...
    ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<ProbGetSick>::out,Filter_ProbGetSick_ports::inToFilter>("input_reader","probGetSickFilter"),
		dynamic::translate::make_IC<Filter_ProbGetSick_ports::outFromFilter,Person_ports::infectionProb>("probGetSickFilter","person")
    };
	...
	/***** (6) *****/
    /*************** Loggers *******************/
    static ofstream out_ProbGetSick("../simulation_results/personAndFilter_test_output_ProbGetSick.txt");
    ...
    static ofstream out_state("../simulation_results/personAndFilter_test_output_state.txt");
